...
const baseConfig: NextConfig = {
	experimental: {
		...
		// Return a routing-level hard 404 for unmatched URLs. Route-level
		// notFound() responses can be streamed with HTTP 200, which search
		// engines classify as soft 404s.
		globalNotFound: true,
	},
