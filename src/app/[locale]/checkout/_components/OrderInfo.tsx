...
export default function OrderInfo({
	...
	const handleAcceptOrder = () => {
		...
		startTransition(async () => {
			...
			try {
				result = await createOrderAction(null, {
					items: orderItems,
					paymentMethod,
					shipmentMethod,
					shippingAddress,
				...
				// A thrown exception here (vs. the action's normal {success:false}
				// result) would otherwise have no local handler — fall back to the
				// same toast UX as every other failure mode instead of letting it
