					...
					<HoverCard.Content>
						...
						<VStack gap='2' alignItems='flex-start'>
							...
							<HStack gap={3} m='auto'>
								<IconButton
									asChild
									aria-label={i18nData.shareTelegram}
									size='md'
									variant='ghost'
									color='main'
									rounded='md'
								...
								<IconButton
									asChild
									aria-label={i18nData.shareWhatsapp}
									size='md'
									variant='ghost'
									color='main'
									rounded='md'
								...
								<IconButton
									asChild
									aria-label={i18nData.shareFacebook}
									size='md'
									variant='ghost'
									color='main'
									rounded='md'
								...
								<IconButton
									asChild
									aria-label={i18nData.shareViber}
									size='md'
									variant='ghost'
									color='main'
									rounded='md'
