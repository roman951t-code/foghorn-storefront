...
import { normalizeMetadataTitle } from './seo';
...
export function mergePageMetadata(base: Metadata, page: PageMeta | null): Metadata {
	...
	const rawTitle = page.metaTitle?.trim() || page.title?.trim();
	const title = rawTitle ? normalizeMetadataTitle(rawTitle) : undefined;
